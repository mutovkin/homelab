...
# NOT a tachometer. No tachometer is COLLECTED anywhere in this role, and under
# the DEFAULT driver set neither host exposes one — but eq12's two fans ARE
# readable via a forced binding of the stock in-kernel it87 module (measured
# 2026-08-25; unpersisted, not collected, operator decision pending —
# docs/eq12.md). n5pro's negative is the definitive one: its EC publishes nothing
# to read (docs/n5pro.md). What this script emits is binary state either way; do
# not rename it to anything speed-shaped.
#
